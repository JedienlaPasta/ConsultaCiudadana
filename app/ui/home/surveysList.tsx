        ...
        {surveysList.map((survey, index) => (
          ...
          >
            <div className="flex grow gap-6">
              <div className="flex-cols relative col-span-2 flex items-center justify-center rounded-lg bg-[#002F4C] px-16 text-slate-100 shadow-md">
                <p className="absolute top-0 left-0 w-full rounded-t-lg bg-[#153D6E] py-2 text-center text-sm text-slate-200">
                  Cierre consulta
                </p>
                <span className="flex flex-col items-center gap-1 text-nowrap">
                  <p className="pt-6 text-3xl font-bold">{index * 10}</p>
              ...
              <div className="col-span-10 flex grow flex-col rounded-lg bg-white shadow-md hover:shadow-lg">
                ...
                <span className="relative right-0 bottom-0 flex w-full justify-between rounded-b-lg bg-slate-100 px-6 py-3 text-right text-sm font-medium text-slate-700 transition-colors duration-300 group-hover:bg-[#3BA6DD] group-hover:text-slate-100">
                  <p className="text-sm">
