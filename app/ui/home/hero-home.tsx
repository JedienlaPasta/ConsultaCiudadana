  ...
  return (
    <div className="relative h-[70vh] w-full">
      ...
      <div className="absolute inset-0 z-10 flex items-center justify-center px-4 text-white md:px-8">
        <div className="container -mt-12 flex max-w-[80rem] grow flex-col items-start px-8 text-center md:text-left">
          <h1 className="mb-6 text-left text-4xl font-bold drop-shadow-lg md:text-6xl lg:text-7xl">
